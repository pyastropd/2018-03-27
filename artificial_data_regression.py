...
#Generate more data to test the performance
...
#plot the predictions as a function of the "real" values
plt.scatter(test_y, pred_y)
plt.show()

#Train the net on more epochs (sees the data 500 times)
nn.fit(train_x, train_y, epochs=500, batch_size=10)

#predict on the test data with the more trained net
pred_y = nn.predict(test_x)
pred_y.shape = [pred_y.size,]
